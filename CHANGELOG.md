...
- **La barre rapide vanilla adopte le style Arcadia** — KubeJS surcharge les quatre sprites HUD de Minecraft 1.21.1 pour la barre de neuf cases, la selection active et les deux orientations de main secondaire. La barre emploie du fer sombre et des separateurs cuivre discrets ; deux engrenages distincts de 11x11 pixels en laiton et cuivre sont affiches deux pixels a l'exterieur de ses extremites, sans pouvoir masquer un objet. Leurs coordonnees suivent automatiquement les dimensions actuelles de l'interface. La case choisie conserve ses accents cuivre, laiton et cyan, tandis que tous les sprites vanilla gardent leurs dimensions d'origine.

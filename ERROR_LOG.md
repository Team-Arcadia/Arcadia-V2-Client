...
## [2026-09-22 10:30] — Ars Blink + warp scroll stalls the server thread (#448)
**Context:** Ticket #448, Blink cast on a player or mob with a bound warp scroll in the off hand, Server1, 2026-09-21 around 22:13.
**Error:** No crash report. Server thread silent from 22:13:23 to 22:18:04 while Worker-Main threads kept generating chunks; spark "Timed out waiting for world statistics"; every player timed out. `max-tick-time=300000`, so the 4 min 40 s stall stayed under the watchdog.

...
- **Arcadia HUD skin** — Custom dark-iron hotbar with copper, brass and arcane-cyan selection accents
...
3. Launcher resolves all 467 entries (441 mods + 26 shaders) automatically
...
| Path | Purpose |
|------|---------|
| `manifest.json` | CurseForge modpack manifest (467 entries: 441 mods + 26 shaderpacks) |
...
- **Skin HUD Arcadia** — Barre rapide en fer sombre avec selection cuivre, laiton et cyan arcanique
...
3. Le launcher resout les 467 entrees (441 mods + 26 shaders) automatiquement
...
| Chemin | Role |
|--------|------|
| `manifest.json` | Manifest CurseForge du modpack (467 entrees : 441 mods + 26 shaderpacks) |
